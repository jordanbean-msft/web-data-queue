...
variable "vnet_bastion_subnet_name" {}
...
locals {
  ...
  bastion_public_ip_name       = "pip-bastion-${var.app}-${var.region}-${var.environment}"
  load_balancer_name           = "lb-${var.app}-${var.region}-${var.environment}"
  bastion_name                 = "bastion-${var.app}-${var.region}-${var.environment}"
}
